  ...
  if (ApexChartsClass) {
    try {
      ...
      const opts = {
        ...
        markers: { size: 4, colors: ['#22c55e'], strokeColors: '#424242', strokeOpacity: 1, fillOpacity: 1 },
  ...
  if (ApexChartsClass) {
    try {
      ...
      const opts = {
        ...
        stroke: { width: 3, curve: 'smooth', colors: ['#424242'], opacity: 1 },
        markers: { size: 4, colors: ['#3b82f6'], strokeColors: '#424242', strokeOpacity: 1, fillOpacity: 1 },
